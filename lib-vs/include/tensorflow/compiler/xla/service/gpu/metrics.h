...
#ifndef TENSORFLOW_COMPILER_XLA_SERVICE_GPU_METRICS_H_
#define TENSORFLOW_COMPILER_XLA_SERVICE_GPU_METRICS_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_SERVICE_GPU_METRICS_H_
